...
const setWhiteBoardHandler = inject("setWhiteBoardHandler") as (
  handler: any
) => {};
...
function onDraw(draw_data: DrawData) {
  ...
  drawOnCanvas(
    ...
    draw_data.prevX,
    draw_data.prevY,
    draw_data.line_color,
    draw_data.line_width
  );
}
...
<template>
  <div class="whiteboard">
    ...
    <div class="tools">
      ...
      <button
        id="blue2"
        style="background-color: #20a0e8"
        @click="setColor('#20a0e8')"
      ></button>
      <button
        id="green"
